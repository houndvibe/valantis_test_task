    ...
    <div>
      {theme == "me" ? (
        ...
        <Flex vertical className={classes.info}>
          ...
          >
            <p>
              Принял решение грузить данные не постранично, а двумя партиями
              т.к. ожидание ответа сервера при каждой смене страницы немного
              утомляет пользователя.
            </p>
            <Divider />
            <p>
              Первым запросом грузится несколько начальных страниц, чтобы юзеру
              было чем заняться, втором запросом, в фоновом режиме, догружаются
              остальные данные.
            </p>
            <Divider />
            <p>
